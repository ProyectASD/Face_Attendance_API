...
//Rutas publicas
router.post("/registro-estudiante",upload.single("fotografia"), registroEstudiante) //variable image del formulario 
...
//Rutas privadas
router.put("/modificar-perfil/:id", upload.single("fotografia"), autenticarEstudiante, modificarPerfilEstudiante)
